...
hMark{5} = annotation(gcf,'textbox', [0.17 0.82 0.04 0.05],'String',{'$\bigtriangleup$'},'Interpreter','latex','FitBoxToText','off','FontName','Arial','EdgeColor','none','FontSize',19);
hMark{6} = annotation(gcf,'textbox', [0.17 0.82 0.04 0.05],'String',{'$\bigtriangleup$'},'Interpreter','latex','FitBoxToText','off','FontName','Arial','EdgeColor','none','FontSize',19);
hMark{7} = annotation(gcf,'textbox', [0.17 0.82 0.04 0.05],'String',{'$\bigtriangleup$'},'Interpreter','latex','FitBoxToText','off','FontName','Arial','EdgeColor','none','FontSize',19);
...
hMark{8}.Position = [0.27  0.189  0.04 0.05];
