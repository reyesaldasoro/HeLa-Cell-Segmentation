...
Hela_LPF                                    = imfilter(Hela,filtG,'replicate');
 ...
 %%
 darkRegions                        = bwlabel( Hela_LPF<(avNucleiIntensity*0.3+0.7*envelopeIntensity));
 ...
 %darkRegions_large_R    = regionprops(darkRegions_large,'Area','Eccentricity','solidity');
...
% darkRegions_large3     = 
 darkRegions_R2                     = regionprops(darkRegions_large2,'Area','Eccentricity','solidity');
