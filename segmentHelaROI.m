...
if levs>1
    IndividualHelaLabels       =  IndividualHelaLabels(:,:,numberOfLabel);
end
...
%% All parameters are ready, select ROI

% Detect centroid of Labelled region
posLabel                       =  regionprops(IndividualHelaLabels,'Area','BoundingBox','Centroid');
